...
\title{Smart IoT: \\Workplace Stress Anxiety \\management and \\empowerment system for the \\People with stress Overflow} % use \\ here otherwise you get a justified title
                                                    % note capitalization of the title (only common 
                                                    % words in lower case)
\tagline{“Managing stress is not an activity, it's a lives-long process.”}                     % tag line
\author{Md Hasnain}                           % your name
\authorID{3021437}                           % your University Identifier
\supervisor{: \\\textbf{Dr. Benjamin Tannert} \\Reviewed by: \\\textbf{Prof. Dr. Heidi Schelhowe}} % your supervisor(s) name - no . in Dr
%\reviewed{: \\\textbf{TBC}} 
\cosupervisor{:\\\textbf{Michael Lund}}                               % your cosupervisor(s) name - no . in Dr ** OPTIONAL ** 
...
\mainmatter 
    ...
    \input{chap2/Theoretical_Background_Related_Work.tex}
    \input{chap3/Concept.tex}
    \input{chap4/System_Overview}
    \input{chap5/Result.tex}
    \input{chap6/Discussion.tex}
    \input{chap7/FutureWork.tex}
